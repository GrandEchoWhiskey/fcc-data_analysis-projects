...
def calculate_demographic_data(print_data=True):
    ...
    earning_percentage_by_country = (country_earnings / country_counts * 100).dropna()

    highest_earning_country = earning_percentage_by_country.idxmax()
    highest_earning_country_percentage = round(earning_percentage_by_country.max(), 1)
