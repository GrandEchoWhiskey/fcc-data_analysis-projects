...
# by dividing their weight in kilograms by the square of their height in meters. If that value is > 25 then the person is overweight. 
...
def draw_cat_plot():
    ...
    # Create a DataFrame for the cat plot using pd.melt with
    # values from cholesterol, gluc, smoke, alco, active, and overweight in the df_cat variable.
